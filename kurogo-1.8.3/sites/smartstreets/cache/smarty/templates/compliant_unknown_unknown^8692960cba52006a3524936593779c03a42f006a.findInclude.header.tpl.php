<?php /* Smarty version Smarty-3.0.7, created on 2013-08-09 14:53:36
         compiled from "findInclude:modules/CatalogueBrowser/templates/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15523613445202dde9c6a7f1-75269872%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    '' => 
    array (
      0 => 'findInclude:modules/CatalogueBrowser/templates/page/navigation/navbar.tpl',
      1 => 1376074370,
      2 => 'findInclude',
    ),
  ),
  'nocache_hash' => '15523613445202dde9c6a7f1-75269872',
  'function' => 
  array (
  ),
...
Module<?php }?><?php if ($_smarty_tpl->getVariable('moduleFillScreen')->value){?> fillscreen<?php }?><?php if ($_smarty_tpl->getVariable('kgoHasNavmenu')->value){?> kgo-has-navmenu<?php }?><?php if ($_smarty_tpl->getVariable('kgoHasNavbar')->value){?> kgo-has-navbar<?php }?><?php if ($_smarty_tpl->getVariable('configModule')->value==$_smarty_tpl->getVariable('homeModuleID')->value&&$_smarty_tpl->getVariable('page')->value=='index'){?> kgo-site-homepage<?php }?>" 
  ...
  <div id="nonfooternav">
    ...
    <?php }else{ ?>
        ...
        <?php $_template = new Smarty_Internal_Template("findInclude:modules/CatalogueBrowser/templates/page/navigation/navbar.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
$_template->properties['nocache_hash']  = '15523613445202dde9c6a7f1-75269872';
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_template;?>
<?php /* Smarty version Smarty-3.0.7, created on 2013-08-09 14:53:36
         compiled from "findInclude:modules/CatalogueBrowser/templates/page/navigation/navbar.tpl" */ ?>
<?php ob_start(); ?>
...
<?php  $_smarty_tpl->assign("kgoNavbarSearch", ob_get_contents()); Smarty::$_smarty_vars['capture']["kgoNavbarSearch"]=ob_get_clean();?>
  ...
  <!-- <div id="navbar"<?php if ($_smarty_tpl->getVariable('hasHelp')->value){?> class="helpon"<?php }?>> -->
    ...
    <!-- <div>Search</div> -->
    <?php echo $_smarty_tpl->getVariable('kgoNavbarSearch')->value;?>
...
<?php /*  End of included template "findInclude:modules/CatalogueBrowser/templates/page/navigation/navbar.tpl" */ ?>
